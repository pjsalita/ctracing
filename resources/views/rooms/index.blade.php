                ...
                <tr class="bg-white border-b">
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="inline-flex rounded-md shadow-sm">
                            <a href="{{ route('room.edit', $room->id) }}" aria-current="page" class="py-2 px-4 text-sm font-medium text-blue-700 bg-white rounded-l-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
                                Edit
                            </a>
